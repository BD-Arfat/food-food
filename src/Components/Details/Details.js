...
const Details = () => {
    ...
    const { name, image, description, price, rating, _id } = useLoaderData();
                ...
                <div className='mt-16 w-1/2'>
                    <div className='mx-auto'>
                        ...
                        <div className='ms-10 text-justify'>
                            ...
                            <h1 className='text-xl mt-3 font-bold text-white'>Rating : {rating}</h1>
                            <h1 className='pr-20'>Description : {description}</h1>
                                        ...
                                        <form onSubmit={handelSubmit} className="card flex-shrink-0 w-full shadow-2xl bg-base-100">
                                            <div className="card-body">
                                                ...
                                                <div className="form-control">
                                                    ...
                                                    <textarea type="text" name='review' className="textarea textarea-warning" placeholder="Write here"></textarea>
                                                </div>
